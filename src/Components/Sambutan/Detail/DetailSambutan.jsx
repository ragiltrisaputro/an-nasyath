    ...
    <div className="max-w-6xl mx-auto p-4 lg:mt-36 mt-20 mb-16 bg-white rounded-lg shadow-xl">
      ...
      >
        ...
        <div className="md:w-1/2 p-4" data-aos="fade-left">
          ...
          <p className="text-base font-poppins md:text-lg mb-4 text-justify">
            Dengan didukung oleh fasilitas dan lingkungan belajar yang kondusif,
            kami mengajak para santri untuk mengeksplorasi potensi akademik,
            spiritual, dan sosial mereka secara maksimal. Kami juga menekankan
            pentingnya pembinaan karakter dan kepemimpinan agar setiap santri
